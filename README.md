...
10. When you test links, that generated by this gem ( with flex form ) - Please make sure that you did not select sub-account at Client Account to "All" inside ccbil admin page. Otherwise you will receive "You have either hit a back button to access an expired session/ or We Cannot process your request at the moment. Please hit refresh or try again later." all the time. If you still receive that message - please check your "formDigest". In order to generate the FormDigest value you put these values in this order:
10.1. initialPrice initialPeriod currencyCode salt
10.2. 40.00 30 840 YOUR_SALT_ENCRYPTED_KEY (no spaces)
10.3. Use [md5-generator](http://www.miraclesalad.com/webtools/md5.php) and put "40.0030840YOUR_SALT_ENCRYPTED_KEY"
10.4. Compare it with received from that Gem.
